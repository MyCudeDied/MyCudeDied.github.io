...
<img id="myImage" src="QuestBoard UI.png" style="left:50%; display:block; width:50%; height:50%;">
<img id="myImage(1)" src="QuestBoard UI (1).png" style="left:50%; display:none; width:50%; height:50%;">
<br>
